...
- (void)testGlucoseReadsConversion {
    ...
    [glucoseRecords addObject:[GlucoseRead valueWithInternalTime:[NSDate dateWithTimeIntervalSinceNow:0]
                                                        userTime:[NSDate dateWithTimeIntervalSinceNow:200]
                                                        timezone:[NSTimeZone timeZoneWithName:@"America/Montreal"]
                                                           value:4.2
                                                            unit:MMOL_PER_L
                                                       timestamp:0]];
...
- (void)testInjectionConversion {
    ...
    [injections addObject:[InsulinInjection valueWithInternalTime:[NSDate dateWithTimeIntervalSinceNow:0]
                                                         userTime:[NSDate dateWithTimeIntervalSinceNow:200]
                                                     userTimezone:[NSTimeZone timeZoneWithName:@"America/Montreal"]
                                                        eventTime:[NSDate dateWithTimeIntervalSinceNow:130]
                                                      insulinType:Basal
                                                        unitValue:1.75
                                                      insulinName:@"Humalog"
                                                        timestamp:0]];
...
- (void)testCalibrationConversion {
    ...
    [calibrations addObject:[MeterRead valueWithInternalTime:[NSDate dateWithTimeIntervalSinceNow:0]
                                                    userTime:[NSDate dateWithTimeIntervalSinceNow:110]
                                                    timezone:[NSTimeZone timeZoneWithName:@"America/Montreal"]
                                                   meterTime:[NSDate dateWithTimeIntervalSinceNow:230]
                                                   meterRead:75.f
...
- (void)testMealConversion {
    ...
    [meals addObject:[FoodEvent valueWithInternalTime:[NSDate dateWithTimeIntervalSinceNow:0]
                                             userTime:[NSDate dateWithTimeIntervalSinceNow:10]
                                         userTimezone:[NSTimeZone timeZoneWithName:@"America/Montreal"]
                                            eventTime:[NSDate dateWithTimeIntervalSinceNow:210]
                                        carbohydrates:10.f
                                             proteins:12.f
                                                  fat:23.f
                                            timestamp:0]];
...
- (void)testExerciseConversion {
    ...
    [exercises addObject:[ExerciseEvent valueWithInternalTime:[NSDate dateWithTimeIntervalSinceNow:0]
                                                     userTime:[NSDate dateWithTimeIntervalSinceNow:10]
                                                 userTimezone:[NSTimeZone timeZoneWithName:@"America/Montreal"]
                                                    eventTime:[NSDate dateWithTimeIntervalSinceNow:20]
                                                     duration:30 * 60.f
